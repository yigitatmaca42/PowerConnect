...
```bash
# 1. Paketi indir
wget https://github.com/yigitatmaca42/PowerConnect/releases/download/v1.0.1/powerconnect_1.0.1_amd64.deb

# 2. Kur
sudo dpkg -i powerconnect_1.0.1_amd64.deb
```
...
```bash
# 1. Paketi indir
wget https://github.com/yigitatmaca42/PowerConnect/releases/download/v1.0.1/powerconnect-client_1.0.1_amd64.deb

# 2. Kur
sudo dpkg -i powerconnect-client_1.0.1_amd64.deb
```
...
│   ├── powerconnect_1.0.1_amd64.deb
│   └── powerconnect-client_1.0.1_amd64.deb
